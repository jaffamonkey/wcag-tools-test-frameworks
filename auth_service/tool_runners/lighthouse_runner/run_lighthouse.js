...
async function main() {
  ...
  if (!jobDir) throw new Error("Usage: node run_lighthouse.js <job_dir>");
  ...
  const reportsDir = path.join(jobDir, "reports", "lighthouse");
    ...
    for (const url of urls) {
      ...
      try {
        ...
        const out = {
          ...
          note: "Starter scaffold: plug in real lighthouse execution here using authenticated Playwright state."
        };
