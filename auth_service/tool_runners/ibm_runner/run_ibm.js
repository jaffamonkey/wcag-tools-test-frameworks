...
async function main() {
  ...
  if (!jobDir) throw new Error("Usage: node run_ibm.js <job_dir>");
  ...
  const reportsDir = path.join(jobDir, "reports", "ibm");
    ...
    for (const url of urls) {
      ...
      try {
        ...
        const out = {
          ...
          note: "Starter scaffold: plug in real ibm execution here using authenticated Playwright state."
        };
